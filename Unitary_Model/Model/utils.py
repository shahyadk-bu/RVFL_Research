...
def load_cifar10_tensors(
    ...
    """
    Loads CIFAR10 and prepares it for the generalized RVFL model.

    CIFAR10 images are originally shape:
        (N, 32, 32, 3)

    After prepare_supervised_tensors(flatten=True), this becomes:
        (N, 3072)
    ...
    # torchvision CIFAR10 stores raw image data as a numpy array with shape (N, 32, 32, 3)
